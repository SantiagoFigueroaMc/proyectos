    ...
    <div className='w-full mt-24'>
        ...
        <div className='max-w-[1240px] mx-auto text-white relative'>
            <div className='px-4 py-12'>
                ...
                <h3 className='text-5xl font-bold py-6 text-center'>Finding the best team</h3>
                <p className='py-4 text-3xl text-slate-300'>Te apoyaremos en lo que sea, solo llama al siguiente contacto.</p>
            </div>
            ...
            <div className='grid lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                <div className='bg-white rounded-xl shadow-2xl'>
                    <div className='p-8'>
                        ...
                        <p className='text-gray-600 text-xl'>Vendemos cosas</p>
                    </div>
